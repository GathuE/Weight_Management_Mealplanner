          ...
          <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card" id="breakfast" class="divs" style="position:relative;top:20px;border-radius:5px; cursor:pointer;">
                        <div class="card-header" style="font-size: 20px;font-weight:900;text-align:center; font-family:'Patrick Hand', cursive;color:purple;">Mid Morning Snack : <br>    
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                          <form class="text-center p-3" name="mealone" style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;" action="insert_midmorning.php" method="post">
                          <!--Day Changing Code -->
                          ...
                          <!--Day Changing Code -->
                                  <div class="row">
                                      ...
                                      <div class="col">
                                          <!-- Food Choice -->
                                          <label> Add Mid Morning Snack? </label><br>
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit" id="breko" class="btn btn-primary" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Mid Morning">
                                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12">
                  <div class="card">
                    <div class="card-header">
                      <h5 style="text-align:center;color:blue;">Mid Morning Snacks</h5>
                    </div>
                    <div class="card-body">
