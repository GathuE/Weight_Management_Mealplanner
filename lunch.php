          ...
          <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card" id="breakfast" class="divs" style="position:relative;top:20px;border-radius:5px; cursor:pointer;">
                        <div class="card-header" style="font-size: 20px;font-weight:900;text-align:center; font-family:'Patrick Hand', cursive;color:purple;">Lunch : <br>    
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                          <form class="text-center p-3" name="mealone" style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;" action="insert_lunch.php" method="post">
                           ...
                           <!--Day Changing Code -->
                            ...
                            <!--Day Changing Code -->
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit" id="breko" class="btn btn-primary" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Lunch">
                                        </div>
                                        
                                </div> 
                                        <div class="card-footer">
                                        <a class="btn btn-info" style="font-size:12px;width:150px;float:left;" href="mid-morning.php">Previous Meal</a>
                                              <a class="btn btn-info" style="font-size:12px;width:150px;float:right;" href="midafternoon.php">Next Meal</a>
                                        </div>
                              </div>
                          </form>
