   ...
   <!DOCTYPE html>
    ...
    <div class="container" id="container">
                    <div class="row justify-content center">
                            <div class="col-12 col-sm-12 col-md-12" id="infosection" style="position:relative;display:block;top:20px;border-radius:5px; cursor:pointer;">
                                    <div class="card" id="display">
                                        <div class="card-body">
                                            <div class="container-fluid">
                                                <!-- <a href="guide.php" class="btn btn-primary" style="color:white;font-size: 12px;font-weight:300;">Guide Book</a><br><br> -->
                                                    <button type="button" class="btn" style="font-size:12px;background-color:purple;color:white;" onclick="start();">Resume Mealplanning</button>
                                                </p>
            ...
            <div class="container" id="container">
                    <div class="row justify-content center">
                        <div class="col-12 col-sm-12 col-md-12">
                            ...
                            <div class="card-body">
                                <div class="container-fluid" id="biocapture">
                                    ...
                                    <form class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;" id="patientform" name="dataform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                        ...
                                                        <input type="number" id="weight" min="15" class="form-control mb-4" name="weight" style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;"  placeholder="Target Weight(Kg)" required >            
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <label> Type of Work :</label><br>
                                                        <select name="work" id="work" class="form-control mb-4"  style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;" required>
                                                                <optgroup placeholder="Type of Work">
                                                                    <option value="" selected>Choose Physical Level of Activity...</option>
                                            ...
                                            <input type="button" class="btn btn-primary" style="font-size:12px;" id="btn" value="Submit" onclick="divswap();EER();"><br>
                            ...
                            <div class="card-footer">
                                    <p style="font-size:16px;font-weight:500;color:blue;">I already know the Client's Nutrient Requirements.<br>
                            ...
                            <form name="eercomposition" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                <table class="table table-striped table-sm text-center">
                                    <thead>
                                            <tr>
                                                <td colspan="5">
                                                <h6 style="font-size:17px;font-family: 'Patrick Hand', cursive;font-weight:600;color:darkblue;">Based on the Data You Provided, <br> YOUR DIETARY REFERENCE INTAKES ARE :</h6>
                                                </td>
                                            </tr>
        ...
        <div class="container" id="container">
                    <div class="row justify-content center">
                            <div class="col-12 col-sm-12 col-md-12" id="prompt" style="position:relative;display:none;top:20px;border-radius:5px; cursor:pointer;">
                                    <div class="card" id="display">
                                        <div class="card-body">
                                            <a class="btn btn-primary" style="font-size:12px;" href="preworkout.php">Proceed</a>
                                        </div>
                                    </div>
                            </div>
                    </div>
