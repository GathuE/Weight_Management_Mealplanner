          ...
          <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card" id="breakfast" class="divs" style="position:relative;top:20px;border-radius:5px; cursor:pointer;">
                        <div class="card-header" style="font-size: 20px;font-weight:900;text-align:center; font-family:'Patrick Hand', cursive;color:purple;">Pre Workout Meal : <br>    
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                          <form id="breakfastform" name="mealone" class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:darkblue;" action="insert_preworkout.php" method="post">
                          ...
                          <!--Day Changing Code -->
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col">
                                          <!-- Food Choice -->
                                          <label> Add Pre Workout Meal ? </label><br>
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit"  class="btn btn-primary" id="breko" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Pre Workout">
                                        </div>
                                        
                                </div> 
                                        <div class="card-footer">
                                              <a class="btn btn-info" style="font-size:12px;width:150px;" href="breakfast_meal.php">Next Meal</a>
                                        </div>
                              </div>
                          </form>
...
if($db === false){
    ...
    WHERE user_id=$user_id AND meal='Preworkout'");
?>
                ...
                <div class="col-12 col-sm-12 col-md-12">
                  <div class="card">
                    <div class="card-header">
                      <h5 style="text-align:center;color:blue;">Pre Workout Meals</h5>
                    </div>
                    <div class="card-body">
...
if($db === false){
    ...
    $select_preworkout_totals= mysqli_query($db, "SELECT patient_meals.meal, patient_meals.foods_id, patient_meals.amount, patient_meals.user_id, foods.name as food, servings.name as serving, 
            ...
            <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                        <?php if (mysqli_num_rows($select_preworkout_totals) > 0 ){ ?>
                            ...
                            <?php
                                $i=0;
                                while ($row = mysqli_fetch_array($select_preworkout_totals)){ 
